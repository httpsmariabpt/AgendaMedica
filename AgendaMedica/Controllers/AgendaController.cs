...
namespace AgendaMedica.Controllers
{
    public class AgendaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AgendaId,PacienteId,MedicoId,DataConsulta")] Agenda agenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("AgendaId,PacienteId,MedicoId,DataConsulta")] Agenda agenda)
        {
